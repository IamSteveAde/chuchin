export const company = {
  ...
  contact: {
    email: "info@chuchinultimate.com",
    phone: "070 3914 5229",
    address: "6 Niyi Ogunbamero Street, Off Chivita Avenue, Ajao Estate, Lagos."
  },
  social: {
    instagram: "#",
    youtube: "#",
...
export const recognitions = [
  { award: "Best Producer (Short Film)", festival: "TINFF", note: "Nomination" },
  { award: "Best International Producer (Nigeria)", festival: "BINFF", note: "Nomination" },
  { award: "Best Producer — We Happy People", festival: "NEMCEA", note: "Winner" },
  { award: "Best Actress — Affiong Go Lagos", festival: "NEMCEA", note: "Winner" },
  { award: "Best Television Series", festival: "TINFF", note: "Nomination" },
  { award: "Best Television Series (Drama)", festival: "TICAFF", note: "Selected" },
  { award: "Best Actress for Affiong go Lagos", festival: "NEMCA", note: "Winner" },
  { award: "Best Television Series (Drama)", festival: "BINFF", note: "Selected" }
];
